...
export function ListingMatchesPage({ role }: { role: Role }) {
  ...
  return (
    <div className="space-y-7">
      ...
      />
      {location.state?.created && <div className="flex gap-3 rounded-2xl border border-[#b9ddc7] bg-[#eff9f2] p-4 text-sm text-[#28624e]"><CheckCircle2 className="mt-0.5 shrink-0" size={18} /><span>Listing published to the Platform Dataset. Now analyze compatible industrial buyers.</span></div>}
