...
import { ArrowLeft, ArrowRight, Check, CheckCircle2, ChevronRight, ClipboardCheck, FileText, Info, Loader2, MapPin, Recycle, Sparkles, WandSparkles } from 'lucide-react'
            ...
            <div className="card p-5 sm:p-7">
              ...
              <div className="mt-6 flex flex-col gap-3 border-t border-[#e4ece6] pt-5 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex flex-wrap items-center gap-2">
                  {form.document_name ? (
                    <span className="badge-safe inline-flex items-center">
                      <CheckCircle2 className="mr-1.5 shrink-0 text-spruce" size={14} />
                      <span>{titleCase(form.quality_grade)} · Document Attached ({form.document_name})</span>
                    </span>
                  ) : (
                    <span className="badge-neutral inline-flex items-center">
                      <Info className="mr-1.5 shrink-0 text-[#60756e]" size={14} />
                      <span>{titleCase(form.quality_grade)} · Supplier-declared (No document attached)</span>
                    </span>
                  )}
                </div>
