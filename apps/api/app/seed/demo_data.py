...
def build_seed_data(include_sample_entities: bool = False) -> dict[str, Any]:
    ...
    listings = [
        ...
        WasteListing(
            id="listing-other-demo",
            company_id="comp-gen-pet",
            material_id="mat-other",
            raw_description="Illustrative demo listing: approximately 3.5 tonnes of mixed custom industrial waste stream in Delhi.",
            source="demo",
            quantity_kg=3500,
            frequency="weekly",
            normalized_kg_per_week=3500,
            quality_grade="industrial",
            quality_verified=True,
            quality_notes="Supplier-declared custom industrial material; verified batch samples available.",
            availability="Weekly scheduled dispatch",
            city="Delhi",
            latitude=28.6139,
            longitude=77.2090,
            asking_price_per_kg=15.0,
            disposal_cost_per_kg=5.0,
            selected_use_id="use-other-repurpose",
            is_demo=True,
            created_at=DEMO_TIMESTAMP,
        ),
    ]
    ...
    lots = [
        ...
        MaterialLot(
            id="lot-other-demo",
            listing_id="listing-other-demo",
            lot_code="OTHER-DEL-W33",
            available_quantity_kg=3500,
            material_form="Production offcuts",
            source_status="pre_consumer",
            colour="Mixed",
            packaging="Industrial containers",
            storage_condition="Covered warehouse storage.",
            sample_available=True,
            compliance_triage="not_assessed",
            declared_spec={"supplier_statement": "Clean custom industrial secondary stream."},
            evidence_ids=[],
            created_at=DEMO_TIMESTAMP,
        ),
    ]
        ...
        "transactions": [
            {
                ...
                "company_id": "comp-buyer-pet-top",
                "status": "accepted",
                "agreed_quantity_kg": 2600,
                "note": "Demo transaction for PET",
                "created_at": DEMO_TIMESTAMP,
            },
            {
                "id": "txn-textile-demo",
                "match_id": "match-listing-textile-demo-req-textile",
                "listing_id": "listing-textile-demo",
                "company_id": "comp-buyer-textile",
                "status": "accepted",
                "agreed_quantity_kg": 4200,
                "note": "Demo transaction for Textile",
                "created_at": DEMO_TIMESTAMP,
            },
            {
                "id": "txn-paper-demo",
                "match_id": "match-listing-paper-demo-req-paper",
                "listing_id": "listing-paper-demo",
                "company_id": "comp-buyer-paper",
                "status": "accepted",
                "agreed_quantity_kg": 6000,
                "note": "Demo transaction for Paper",
                "created_at": DEMO_TIMESTAMP,
            }
        ],
    }
