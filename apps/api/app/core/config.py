...
class Settings:
    ...
    admin_email: str | None = field(default_factory=lambda: os.getenv("ADMIN_EMAIL") or os.getenv("VITE_ADMIN_EMAIL") or os.getenv("RESEND_TEST_EMAIL") or "admin@circularmatch.com")
